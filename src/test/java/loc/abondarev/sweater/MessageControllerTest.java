package loc.abondarev.sweater;

import loc.abondarev.sweater.controller.MessageController;
...
@Sql(value={"/messages-list-after.sql", "/drop-user-after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
public class MessageControllerTest {
    ...
    public void addMessageToListTest() throws Exception {
        final MockHttpServletRequestBuilder multipart = multipart("/main")
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/i").string("#new_one"));
    }
}
